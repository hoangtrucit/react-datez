...
class Home extends Component {
  constructor(props) {
    super(props);
    this.state = {
      dateInput: "1999-06-25T17:00:00.000Z"
    };
    ...
    return (
      <div className="container">
        ...
        <form onSubmit={this.props.handleSubmit(this.nextStep)}>
          ...
          {/*<label htmlFor="exampleDate1" className="m-b-1">*/}
          ...
          <div className="form-group m-b-3">
            <label htmlFor="exampleDate2" className="m-b-1">
              Multi-calendar Picker (Non Redux)
            </label>
            <ReactDatez
              name="dateInput"
          ...
          {/*<div className="form-group m-b-3">*/}
          {/*<label htmlFor="exampleDate3" className="m-b-1">*/}
          {/*Highlight Weekends*/}
          {/*</label>*/}
          ...
          {/*<div className="form-group m-b-3">*/}
          {/*<label htmlFor="exampleDate4" className="m-b-1">*/}
          {/*Allow Past Dates*/}
          {/*</label>*/}
          {/*<Field*/}
          {/*name="exampleDate4"*/}
          ...
          {/*<div className="form-group m-b-3">*/}
          {/*<label htmlFor="exampleDate5" className="m-b-1">*/}
          ...
          {/*<div className="form-group m-b-3">*/}
          {/*<label htmlFor="exampleDate5" className="m-b-1">*/}
          {/*Disallow Dates Outside of Range*/}
          {/*</label>*/}
          {/*<Field*/}
          {/*name="exampleDate6"*/}
          {/*component={ReduxReactDatez}*/}
          ...
          {/*<div className="form-group m-b-3">*/}
          {/*<label htmlFor="exampleDate6" className="m-b-1">*/}
          {/*Disallow Year Jump*/}
          {/*</label>*/}
          ...
          {/*<div className="form-group m-b-3">*/}
          {/*<label htmlFor="dateOfBirth" className="m-b-1">*/}
          {/*Date of Birth*/}
          {/*</label>*/}
          {/*<Field*/}
          {/*name="dateOfBirth"*/}
